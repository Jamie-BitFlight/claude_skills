...
**Fact-check**: VERIFIED — Hardcoded path `/home/user/repos/claude_skills/.claude/agent-memory/service-docs-maintainer/` in `plugins/development-harness/agents/service-docs-maintainer.md` line 164.
