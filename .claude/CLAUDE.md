...
`.claude-plugin/` (nearly all have `.codex-plugin/`; `.cursor-plugin/` coverage is partial — see
AGENTS.md's Repository Overview), so "which skill to use when" is a project workflow rule, not a
