...
- [feedback_typer_echo_vs_logging_capture.md](./feedback_typer_echo_vs_logging_capture.md) — CliRunner tests: typer.echo() output reaches result.output; a logging.StreamHandler created before the test run writes elsewhere
