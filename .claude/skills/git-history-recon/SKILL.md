...
- SOURCE: `assets/exclude-patterns` (this skill's own file) — default exclusion patterns and their per-pattern rationale; reproduce with the command in that file's own header (accessed 2026-09-03)
