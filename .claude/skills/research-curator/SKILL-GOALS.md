...
5. Convert passive research into actionable follow-through — automatically extract improvement proposals into the backlog, assess direct utilization/integration opportunities, and build a bidirectional cross-reference graph linking related entries, so a new entry does not sit inert
