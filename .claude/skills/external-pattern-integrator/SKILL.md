---
description: 'Integrate patterns from external sources (URLs or files) into local skills, agents, and plugins. Use when: (1) comparing external agent/skill definitions against local equivalents, (2) extracting best practices from open-source frameworks like GSD or BMAD-METHOD, (3) enhancing local skills with patterns from external sources, (4) ensuring interoperability with external tool ecosystems.'
