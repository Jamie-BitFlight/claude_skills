...
3. **Claude Code Hooks**: Full integration with Claude Code's PreToolUse and PostToolUse hooks — the
   same two events this repository already drives from `.claude/hooks/`:
