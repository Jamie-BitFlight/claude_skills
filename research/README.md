...
| [2026-04-26-tolaria-utilization.md](./insights/2026-04-26-tolaria-utilization.md) | The research-context-agent currently discovers integration opportunities by searching the repo codebase (skills, agents, plugins, commands) and validates claims against primary sources. It searches for existing skill/agent/hook/command coverage, then proposes new capabilities. | 2026-05-12 |
