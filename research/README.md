...
│   ├── claude-code-skills-alirezarezvani.md # 362 modular skill packages for Claude Code, Codex, Gemini CLI, Cursor across 18 domains; v2.9.0 (24.2K stars)
│   ├── clawhub.md                     # Skill registry for AI agents with vector search
│   ├── compound-engineering-plugin.md # Every Inc's planning-first (80%) workflow: brainstorm → plan → review → work → compound (MIT, v3.21.4, 32 skills)
...
| [screenpipe.md](./mcp-ecosystem/screenpipe.md)             | Screenpipe v0.3.307 — MCP server with event-driven screen capture, OCR, SQLite/FTS5, Whisper transcription; REST API on localhost:3030 | 2026-04-20   |
...
| [claude-code-skills-alirezarezvani.md](./skill-generation-tools/claude-code-skills-alirezarezvani.md) | Claude Code Skills Library - 362 production-ready modular skill packages across 18 domains (engineering, marketing, C-level, compliance, product, regulatory, finance) for Claude Code, Codex, Gemini CLI, Cursor; 644 stdlib-only Python tools; v2.9.0 (24.2K stars) | 2026-08-11   |
...
| [agent-skills.md](./skill-generation-tools/agent-skills.md) | Agent Skills (Addy Osmani) — production-grade skills library for AI coding agents; 24 skills across 6 lifecycle phases (DEFINE/PLAN/BUILD/VERIFY/REVIEW/SHIP), 8 slash commands, 4 specialist agent personas, 70+ agent ecosystem support (MIT, v1.0.0) | 2026-07-07   |
| [claude-night-market.md](./skill-generation-tools/claude-night-market.md) | Claude Night Market — Claude Code plugin marketplace with 23 plugins, 201 skills, 163 commands, and 56 agents for software engineering workflows (v1.9.17, 327 stars). | 2026-08-11 |
| [compound-engineering-plugin.md](./skill-generation-tools/compound-engineering-plugin.md) | Compound Engineering Plugin — Every Inc's planning-first (80/20) workflow across 14 AI coding platforms; 32 skills, no standalone agents (MIT, v3.21.4, 24.1K stars). | 2026-08-11 |
...
| [hmohamed-claude-code-plugins.md](./skill-generation-tools/hmohamed-claude-code-plugins.md) | hmohamed/claude-code-plugins — monorepo of Swift and Rust Claude Code plugins with specialized agents, skills, hooks, and utility scripts. | 2026-01-31 |
| [huashu-design.md](./skill-generation-tools/huashu-design.md) | Huashu Design — Design Skill for AI Agents | 2026-05-12 |
| [impeccable.md](./skill-generation-tools/impeccable.md) | Impeccable — cross-provider design skill platform with a core frontend-design skill and 20 focused design commands for multiple AI coding harnesses. | 2026-05-12 |
| [visual-explainer.md](./skill-generation-tools/visual-explainer.md) | visual-explainer — skill and prompt templates for generating self-contained HTML diagrams and visual review artifacts using Mermaid and web UI primitives. | 2026-02-26 |
...
| [esp-claw.md](./agent-frameworks/esp-claw.md)                         | Espressif's event-driven AI agent framework for ESP32-S3; local LLM inference with 400KB SRAM constraint; Bidirectional MCP integration; on-device long-term memory with JSONL persistence | 2026-04-20   |
...
| [agno.md](./agent-frameworks/agno.md) | Agno is a Python framework for building multi-agent systems that learn and improve with every interaction. Unlike stateless agents that forget after each session, Agno agents persist user profiles... | 2026-01-31 |
| [bmad-method.md](./agent-frameworks/bmad-method.md) | BMAD-METHOD (Breakthrough Method of Agile AI-Driven Development) is an AI-driven agile development framework providing 21 specialized agents, 50+ guided workflows, and scale-adaptive intelligence... | 2026-02-01 |
| [google-adk.md](./agent-frameworks/google-adk.md) | An open-source, code-first Python framework from Google for building, evaluating, and deploying sophisticated AI agents with multi-agent orchestration, MCP integration, and Vertex AI deployment support. | 2026-02-26 |
...
| [cua.md](./agent-infrastructure/cua.md) | CUA (Computer-Use Agents) — open-source infrastructure for AI agents with cross-platform desktop/mobile GUI interaction, unified API over Docker/KVM/Parallels/VirtualBox/Android, vision-based screen interaction, H.265 video encoding, OSWorld/ScreenSpot/Windows Arena benchmarking (15.5K stars, MIT) | 2026-05-03   |
...
| [no-mistakes.md](./developer-tools/no-mistakes.md)     | no-mistakes — Git push quality gate for AI-driven development; isolated worktrees, AI-driven validation pipeline, auto-fix capability (413 stars, MIT, v1.11.0) | 2026-05-03   |
...
| [ghost-desk.md](./developer-tools/ghost-desk.md)       | Ghost Desk — Windows AI overlay assistant invisible during screen shares/recordings via OS-level "hardware DWM capture exclusion"; Llama 3.3 70B chat, Llama 4 Scout vision, Deepgram Nova-3 transcription; 14-platform verification dashboard (proprietary, paid-only as of 2026-08-11) | 2026-03-13   |
...
| [abtop.md](./developer-tools/abtop.md) | abtop is a real-time terminal user interface monitor for AI coding agents, inspired by btop (a system resource monitor). It displays live metrics for Claude Code and Codex CLI sessions, including token consumption, context window utilization, rate limit quotas, running child processes, and orphaned ports. The tool read | 2026-04-25 |
...
| [gitdocify.md](./documentation-tools/gitdocify.md) | GitDocify is a commercial SaaS tool that generates README documentation for GitHub repositories using AI. Users connect their GitHub account, select a repository (public or private depending on... | 2026-01-31 |
...
| [code-simplifier.md](./coding-agents/code-simplifier.md) | The Code Simplifier is an official Anthropic Claude Code plugin that provides an autonomous agent (powered by Claude Opus) for simplifying and refining code for clarity, consistency, and maintainability. It operates proactively after code is written or modified — without requiring explicit user requests — applying proj | 2026-02-23 |
| [pi-mono.md](./coding-agents/pi-mono.md) | A TypeScript monorepo providing a minimal, extensible coding agent CLI, unified multi-provider LLM API, TUI and web UI libraries, Slack bot, and vLLM pod management. Designed for workflow adaptability via extensions, skills, and prompt templates rather than opinionated built-in features. | 2026-02-26 |
...
| Document                                                  | Description                                                                                                                    | Last Updated |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [claude-brain.md](./context-management/claude-brain.md)   | Claude-Brain — persistent memory plugin for Claude Code with lifecycle hooks (SessionStart, PostToolUse, Stop); optional memvid-cli and Mind SDK integration | 2026-04-20   |
...
| [slimcontext.md](./context-management/slimcontext.md)     | SlimContext — zero-dependency TypeScript library for chat history compression; TrimCompressor (token-based drop) and SummarizeCompressor (AI-powered); BYOM model interface; preserves system messages and recent messages by default (v2.1.3; repo ARCHIVED read-only as of 2026-08-11) | 2026-03-17   |
...
| [huashu-design.md](./ai-design-tools/huashu-design.md) | Huashu Design — AI-native design skill for Claude Code; generates production-grade design deliverables (prototypes, slides, motion graphics) from natural language; conversational workflow + brand asset protocol (12K+ stars, Personal Use Only) | 2026-05-03   |
...
| [tolaria.md](./ai-design-tools/tolaria.md) | Tolaria v0.1.0 alpha (May 2026) — Three-layer architecture: markdown → JSON cache → React state; Tauri 2 desktop application (Rust + React); bundled MCP server | 2026-04-20   |
...
| [interface-design.md](./ai-design-tools/interface-design.md) | Claude Code plugin that brings craft, memory, and consistency to AI-generated UI. Principle-based design system for dashboards, apps, and tools — saves design decisions to system.md and loads them automatically each session. | 2026-02-26 |
...
| Document                                                                                          | Description                                                                                                                           | Last Updated |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| [agent-skills-eval.md](./evaluation-testing/agent-skills-eval.md)                                 | agent-skills-eval -- TypeScript SDK and CLI for empirically evaluating Agent Skills with judge-graded baseline comparison; OpenAI-compatible, iteration-N artifact layout (MIT, v0.1.1) | 2026-05-09   |
...
| [type-ai.md](./ai-writing-tools/type-ai.md) | Type.ai is an AI-first document editor designed for long-form professional writing. Unlike chat-based AI tools (ChatGPT, Claude), Type.ai embeds AI capabilities directly into a feature-rich document... | 2026-01-31 |
...
| [tooljet.md](./low-code-platforms/tooljet.md) | ToolJet is an open-source low-code platform for building internal tools, dashboards, business applications, workflows, and AI agents. The platform provides a visual drag-and-drop builder with 60+... | 2026-01-31 |
...
**Location**: [./developer-tooling/](./developer-tooling/)
...
| Document | Description | Last Updated |
|---|---|---|
| [2026-03-07-claude-code-prompt-improver-improvements.md](./insights/2026-03-07-claude-code-prompt-improver-improvements.md) | The `hooks-patterns` SKILL.md contains a `UserPromptSubmit` example (line 306, "Python: UserPromptSubmit Context and Validation") that demonstrates JSON output and context injection. However, this example only shows how to validate and add context to a prompt. It does not demonstrate the pattern of: 1. Evaluating promp | 2026-05-12 |
| [2026-03-10-claude-code-skills-alirezarezvani-improvements.md](./insights/2026-03-10-claude-code-skills-alirezarezvani-improvements.md) | `plugin_validator.py` validates structural concerns: YAML frontmatter schema, token complexity, internal link validity, plugin.json compliance, and progressive disclosure structure. It does not scan skill content for security risks such as command injection patterns in scripts, data exfiltration vectors in hook command | 2026-05-12 |
| [2026-03-10-cocoindex-code-improvements.md](./insights/2026-03-10-cocoindex-code-improvements.md) | The fastmcp-creator SKILL.md trigger matrix includes server creation, deployment, and Claude Code integration. The `claude-code-mcp-integration.md` reference covers `.mcp.json` configuration. Neither the SKILL.md nor the visible portions of reference files contain explicit guidance on implementing automatic project roo | 2026-05-12 |
| [2026-03-10-everything-claude-code-improvements.md](./insights/2026-03-10-everything-claude-code-improvements.md) | `task_status_hook.py` handles `SubagentStop` by marking the task COMPLETE, adding a `completed` timestamp, deleting the context file, and syncing completion to GitHub. It does NOT capture any summary of what the subagent accomplished — no record of files changed, tests written, errors encountered, or decisions made. Th | 2026-05-12 |
| [2026-03-12-obsidian-skills-improvements.md](./insights/2026-03-12-obsidian-skills-improvements.md) | The skill-creator SKILL.md (section "Concise is Key", line ~70) instructs skill authors: "Default assumption: Claude is already very smart. Only add context Claude doesn't already have. Challenge each piece of information: 'Does Claude really need this explanation?'" The init_skill.py template generates section headers | 2026-05-12 |
| [2026-03-12-trainloop-improvements.md](./insights/2026-03-12-trainloop-improvements.md) | 2026 03 12 trainloop improvements | 2026-05-12 |
| [2026-03-13-claude-replay-utilization.md](./insights/2026-03-13-claude-replay-utilization.md) | The transcript-analysis skill processes Claude Code JSONL session transcripts and writes findings to markdown reports (`.planning/kaizen/analysis-DATE.md`). When the analysis identifies significant patterns — anti-patterns, inefficiencies, frustration signals, or workflow innovations — the findings reference specific s | 2026-05-12 |
| [2026-03-13-gstack-improvements.md](./insights/2026-03-13-gstack-improvements.md) | The code-reviewer agent (`plugins/python3-development/agents/code-reviewer.md`) focuses exclusively on architecture compliance, pattern compliance, dependency utilization, and testing standards. Its Review Checklist (lines 129-161) covers type hints, docstrings, module placement, Rich/Typer patterns, and test coverage. | 2026-05-12 |
| [2026-03-13-mcpskills-cli-improvements.md](./insights/2026-03-13-mcpskills-cli-improvements.md) | 2026 03 13 mcpskills cli improvements | 2026-05-12 |
| [2026-03-13-mcpskills-cli-utilization.md](./insights/2026-03-13-mcpskills-cli-utilization.md) | - CLI tool: `mcpskills-cli` (pip-installable, Python >= 3.10) - API: Streamable HTTP + fastmcp client - Output: SKILL.md + language-specific call scripts (bash, python, node, go, rust) - Callable via: subprocess (Bash, Python) | 2026-05-12 |
| [2026-03-13-msgspec-improvements.md](./insights/2026-03-13-msgspec-improvements.md) | 2026 03 13 msgspec improvements | 2026-05-12 |
| [2026-03-13-msgspec-utilization.md](./insights/2026-03-13-msgspec-utilization.md) | The `_read_jsonl()` function in agentskill-kaizen's MCP server reads JSONL session transcript files by calling `json.loads()` on each line in a list comprehension (line 102). The function currently accepts unvalidated JSON and returns `list[dict[str, Any]]`. According to msgspec benchmarks in the research entry, msgspe | 2026-05-12 |
| [2026-03-13-scrapling-skill-improvements.md](./insights/2026-03-13-scrapling-skill-improvements.md) | Skills in this repository do not have a standardized mechanism for saving learned patterns back into their own reference files during execution. When a skill successfully handles a novel scenario, the knowledge is captured in MEMORY.md (session-level) or `rules/` (manually added), but not in a skill-local struc | 2026-05-12 |
| [2026-03-13-stakpak-agent-improvements.md](./insights/2026-03-13-stakpak-agent-improvements.md) | `task_status_hook.py` writes `LastActivity` timestamps on every Write/Edit/Bash tool call during task execution. However, no process reads this field to detect stalled agents or provide progress feedback. The `implementation_manager.py` `status` and `ready-tasks` commands return task metadata but do not compare `LastAc | 2026-05-12 |
| [2026-03-13-unblocked-improvements.md](./insights/2026-03-13-unblocked-improvements.md) | The code-reviewer agent (plugins/python3-development/agents/code-reviewer.md) reviews code against a static set of generic Python standards hardcoded in the agent file (layered architecture, Typer/Click patterns, shared/ module conventions, pytest). It does not dynamically retrieve project-specific conventions, histori | 2026-05-12 |
| [2026-03-14-pi-mono-improvements.md](./insights/2026-03-14-pi-mono-improvements.md) | 2026 03 14 pi mono improvements | 2026-05-12 |
| [2026-03-14-pi-mono-utilization.md](./insights/2026-03-14-pi-mono-utilization.md) | Pi-mono documents **three callable surfaces**: | 2026-05-12 |
| [2026-03-15-zvec-utilization.md](./insights/2026-03-15-zvec-utilization.md) | The context-gathering agent currently reads files extensively (Step 2: "Hunt down...") using grep, glob, and direct file reads to locate relevant code paths, dependencies, and configuration. This is keyword-driven matching. When searching for "authentication flows" or "caching patterns," the agent may miss semantically | 2026-05-12 |
| [2026-03-16-claude-scientific-skills-improvements.md](./insights/2026-03-16-claude-scientific-skills-improvements.md) | The skill-creator skill documents how to create individual skills (anatomy, frontmatter, progressive disclosure, bundled resources) but contains no guidance on composing multiple skills into compound workflows. Grep for "skill-composition", "cross-domain", and "compound workflow" across `.claude/` and `plugins/plugin-c | 2026-05-12 |
| [2026-03-17-1code-improvements.md](./insights/2026-03-17-1code-improvements.md) | `plugins/python3-development/skills/implement-feature/SKILL.md` dispatches task agents directly into full execution mode via `Skill(skill="start-task", ...)`. No mechanism exists for the agent to surface a structured plan for human review before the sub-agent executes file edits, bash commands, or other irreversible op | 2026-05-12 |
| [2026-03-17-1code-utilization.md](./insights/2026-03-17-1code-utilization.md) | The `code-quality.yml` workflow runs lint, type-check, plugin validation, manifest sync, and test jobs aggregated under a `quality-gate` job using `re-actors/alls-green`. When the gate fails there is no remediation step — a developer must manually investigate, fix, and re-push. The 1Code REST API accepts a repository U | 2026-05-12 |
| [2026-03-17-agent-deck-improvements.md](./insights/2026-03-17-agent-deck-improvements.md) | `task_status_hook.py` writes status changes (COMPLETE, LastActivity) directly into YAML frontmatter of task files via `sam_schema.core.query.update_status` and `sam_schema.core.query.update_plan_fields`. The `sam` CLI reads these YAML files to compute status and readiness. There is no indexed event store -- every statu | 2026-05-12 |
| [2026-03-17-agent-deck-utilization.md](./insights/2026-03-17-agent-deck-utilization.md) | Agent Deck provides rich integration surfaces but requires an architectural component that does not yet exist in this codebase: | 2026-05-12 |
| [2026-03-17-awesome-ai-apps-improvements.md](./insights/2026-03-17-awesome-ai-apps-improvements.md) | The repo has two memory mechanisms: (1) agent-level `memory: project` frontmatter that persists agent observations within a project scope, and (2) the `claude-mem` MCP plugin providing `get_observations`, `search`, `smart_search`, `smart_outline`, `smart_unfold`, and `timeline` tools. Neither mechanism is documented as | 2026-05-12 |
| [2026-03-17-ctxforge-improvements.md](./insights/2026-03-17-ctxforge-improvements.md) | The `rules/` directory holds rule files focused on structural concerns, among them: silent failure prevention, large file write strategy, interactive terminal workarounds, language conventions, script invocation, linting exceptions, CI workflows, YAML/TOML libraries, plugin development, skill content optimization, fr | 2026-05-12 |
| [2026-03-17-sidecar-improvements.md](./insights/2026-03-17-sidecar-improvements.md) | The `task_status_hook.py` writes an ephemeral context file at `.claude/context/active-task-{session_id}.json` containing `task_file_path`, `task_id`, and optionally `parent_issue_number`. This file is deleted by the SubagentStop hook when the sub-agent finishes. The `LastActivity` timestamp is written to the task file' | 2026-05-12 |
| [2026-03-17-slimcontext-improvements.md](./insights/2026-03-17-slimcontext-improvements.md) | The task_status_hook.py script fires on PostToolUse (Write\|Edit\|Bash) events and updates LastActivity timestamps. There is no mechanism in this repository that controls when Claude Code's internal context compaction triggers. Context compaction can occur mid-tool-use-cycle, as documented in backlog item #113 (observe | 2026-05-12 |
| [2026-03-18-codewiki-google-improvements.md](./insights/2026-03-18-codewiki-google-improvements.md) | The `doc-drift-auditor` agent runs exclusively as Phase 4 of `/complete-implementation` (file: plugins/python3-development/skills/complete-implementation/SKILL.md). It audits documentation accuracy against implementation only after all feature tasks reach COMPLETE status. Between feature completions, documentation drif | 2026-05-12 |
| [2026-03-18-emqutiti-improvements.md](./insights/2026-03-18-emqutiti-improvements.md) | 2026 03 18 emqutiti improvements | 2026-05-12 |
| [2026-03-18-glm5-exacto-improvements.md](./insights/2026-03-18-glm5-exacto-improvements.md) | The research entry's "Integration Opportunities" section proposes using GLM-5 as an alternative or fallback model for coding tasks. This concept is already tracked as backlog item **#108 SAM: Multi-Model Strategy** (P2). No new backlog item is warranted. | 2026-05-12 |
| [2026-03-18-merly-mentor-improvements.md](./insights/2026-03-18-merly-mentor-improvements.md) | `validate_research.py` performs structural validation of research entries: section completeness, header fields, empty sections, access dates, freshness tracking, statistics currency, URL format, cross-references, and formatting suggestions. No check exists for whether code blocks within research entries contain syntact | 2026-05-12 |
| [2026-03-18-merly-mentor-utilization.md](./insights/2026-03-18-merly-mentor-utilization.md) | Merly Mentor documents the following integration surfaces: | 2026-05-12 |
| [2026-03-18-stoat-improvements.md](./insights/2026-03-18-stoat-improvements.md) | 2026 03 18 stoat improvements | 2026-05-12 |
| [2026-03-18-the-delegation-improvements.md](./insights/2026-03-18-the-delegation-improvements.md) | The SAM workflow has three implicit phases (planning via `/add-new-feature`, execution via `/implement-feature`, quality gates via `/complete-implementation`) but no explicit plan-level phase field in the data model. Running `uv run sam status P{N}` returns task counts (`total_tasks`, `by_status`, `ready_tasks`, `block | 2026-05-12 |
| [2026-03-18-tori-cli-improvements.md](./insights/2026-03-18-tori-cli-improvements.md) | Task readiness in the SAM system is determined solely by dependency graph resolution: a task is "ready" when its status is `NOT STARTED` and all dependency tasks have status `COMPLETE`. There is no mechanism to express conditional readiness based on observable system state (e.g., "file X exists", "command Y exits 0", " | 2026-05-12 |
| [2026-03-19-AutoResearchClaw-improvements.md](./insights/2026-03-19-AutoResearchClaw-improvements.md) | The research-curator `--validate` mode checks structural issues (missing required fields, broken links, malformed frontmatter) via `validate_research.py`. It does not verify that cited sources actually exist or are relevant. Citations in research entries (URLs, arXiv IDs, DOI references) are taken at face value. The CL | 2026-05-12 |
| [2026-03-19-gitnexus-improvements.md](./insights/2026-03-19-gitnexus-improvements.md) | 2026 03 19 gitnexus improvements | 2026-05-12 |
| [2026-03-19-gitnexus-utilization.md](./insights/2026-03-19-gitnexus-utilization.md) | The python3-development plugin contains multiple agents that review code and assess impact (code-reviewer, context-refinement, feature-verifier agents documented in local-workflow.md). Currently, these agents rely on: - Manual symbol tracing through grep/Glob searches (line 36 in research entry notes Grep is used for e | 2026-05-12 |
| [2026-03-19-open-pencil-improvements.md](./insights/2026-03-19-open-pencil-improvements.md) | 2026 03 19 open pencil improvements | 2026-05-12 |
| [2026-03-19-simplemem-cross-improvements.md](./insights/2026-03-19-simplemem-cross-improvements.md) | The task_status_hook.py writes `LastActivity` timestamps and `Completed` timestamps per task. The `.claude/context/active-task-{session_id}.json` file tracks the currently active task but is deleted on SubagentStop. No mechanism persists session context (decisions made, files modified, discoveries) across independent s | 2026-05-12 |
| [2026-03-19-simplemem-cross-utilization.md](./insights/2026-03-19-simplemem-cross-utilization.md) | The context-gathering agent reads task files and performs expensive codebase research to assemble complete context manifests for implementation agents. Currently, every new task triggers a full re-scan of the codebase even when discovering similar context (e.g., "find all CLI command patterns"). SimpleMem-Cross would r | 2026-05-12 |
| [2026-03-21-zeroboot-improvements.md](./insights/2026-03-21-zeroboot-improvements.md) | 2026 03 21 zeroboot improvements | 2026-05-12 |
| [2026-03-23-composure-utilization-assessment.md](./insights/2026-03-23-composure-utilization-assessment.md) | Composure is a **closed-source marketplace plugin** for Claude Code that enforces code quality through automated hooks, skills, and an MCP code review knowledge graph. While it documents valuable architectural patterns (three-layer hook gating, SQLite-backed code graphs, severity-tracked task queues), **it does not exp | 2026-05-12 |
| [2026-03-23-maverick-improvements.md](./insights/2026-03-23-maverick-improvements.md) | The `/plugin-creator:skill-creator` skill creates new skills from scratch via a 10-step interactive process. There is no mechanism that automatically scans a project's codebase, detects which practices (logging, testing, linting, CI/CD) are already implemented, and generates project-specific skill files documenting tho | 2026-05-12 |
| [2026-03-24-anything_about_game_ai_resources-improvements.md](./insights/2026-03-24-anything_about_game_ai_resources-improvements.md) | 2026 03 24 anything_about_game_ai_resources improvements | 2026-05-12 |
| [2026-03-24-claude-code-cli-power-patterns-improvements.md](./insights/2026-03-24-claude-code-cli-power-patterns-improvements.md) | `kage-bunshin/scripts/spawn.py` accepts `--model` to select the model (haiku, sonnet, opus) but has no `--effort` flag to set `CLAUDE_CODE_EFFORT_LEVEL` on the spawned `claude` process. The `work-milestone/SKILL.md` hardcodes `--model sonnet` in its spawn command template (line 48: `claude -p --model sonnet`) without a | 2026-05-12 |
| [2026-03-24-claude-code-cli-power-patterns-utilization.md](./insights/2026-03-24-claude-code-cli-power-patterns-utilization.md) | The `/work-milestone` skill spawns independent `claude -p` (kage-bunshin) sessions, one per wave item, each in its own git worktree. The research entry documents `--worktree` as a native git worktree mechanism that eliminates race conditions when multiple agents modify the same repository. The skill already uses this p | 2026-05-12 |
| [2026-03-24-gridland-improvements.md](./insights/2026-03-24-gridland-improvements.md) | 2026 03 24 gridland improvements | 2026-05-12 |
| [2026-03-24-vibium-improvements.md](./insights/2026-03-24-vibium-improvements.md) | 2026 03 24 vibium improvements | 2026-05-12 |
| [2026-03-24-vibium-utilization.md](./insights/2026-03-24-vibium-utilization.md) | The agent-browser skill (`.claude/skills/agent-browser/SKILL.md`) currently provides browser automation to AI agents using Playwright. It handles navigation, element finding, form filling, screenshots, and session persistence. The skill's purpose and workflow are fully compatible with Vibium's API surface. | 2026-05-12 |
| [2026-03-25-samuraizer-improvements.md](./insights/2026-03-25-samuraizer-improvements.md) | 2026 03 25 samuraizer improvements | 2026-05-12 |
| [2026-03-25-samuraizer-utilization.md](./insights/2026-03-25-samuraizer-utilization.md) | architecture with a purpose-built knowledge base providing vector embeddings, semantic search, and RAG chat over the research corpus. SQLite database; cannot be used as a stateless dependency) (vector similarity search), `POST /chat` (RAG over stored entries) | 2026-05-12 |
| [2026-03-26-xyops-improvements.md](./insights/2026-03-26-xyops-improvements.md) | 2026 03 26 xyops improvements | 2026-05-12 |
| [2026-03-28-agentscope-improvements.md](./insights/2026-03-28-agentscope-improvements.md) | The fastmcp-creator SKILL.md focuses on server creation (`@mcp.tool`, `@mcp.resource`, providers, transforms, deployment). The trigger matrix includes a "Write a FastMCP client" row pointing to `./references/client-sdk.md`, but the skill's primary orientation is server-side. AgentScope's pattern of obtaining individual | 2026-05-12 |
| [2026-03-28-agentscope-utilization.md](./insights/2026-03-28-agentscope-utilization.md) | AgentScope is a production-ready agent framework providing: | 2026-05-12 |
| [2026-03-28-beads-improvements.md](./insights/2026-03-28-beads-improvements.md) | Completed SAM tasks remain in plan files with full detail (requirements, constraints, acceptance criteria, verification steps). When an orchestrator runs `sam_status` or `sam_read` on a long-running plan with many completed tasks, the full task bodies consume context window tokens unnecessarily. No mechanism exists to  | 2026-05-12 |
| [2026-03-28-chroma-improvements.md](./insights/2026-03-28-chroma-improvements.md) | 2026 03 28 chroma improvements | 2026-05-12 |
| [2026-03-28-claude-skills-library-improvements.md](./insights/2026-03-28-claude-skills-library-improvements.md) | The local repo validates skills via `skilllint` (frontmatter schema, token counts, link validity) and the `/assessor` skill (4-tier structural/semantic analysis). There is no single document defining a sequential production pipeline with numbered phases (discovery, design, development, testing, documentation, quality g | 2026-05-12 |
| [2026-03-28-cmux-improvements.md](./insights/2026-03-28-cmux-improvements.md) | 2026 03 28 cmux improvements | 2026-05-12 |
| [2026-03-28-fleet-improvements.md](./insights/2026-03-28-fleet-improvements.md) | 2026 03 28 fleet improvements | 2026-05-12 |
| [2026-03-28-holyclaude-improvements.md](./insights/2026-03-28-holyclaude-improvements.md) | 2026 03 28 holyclaude improvements | 2026-05-12 |
| [2026-03-28-nemoclaw-improvements.md](./insights/2026-03-28-nemoclaw-improvements.md) | 2026 03 28 nemoclaw improvements | 2026-05-12 |
| [2026-03-28-oh-my-claudecode-improvements.md](./insights/2026-03-28-oh-my-claudecode-improvements.md) | The implement-feature progress loop (lines 38-114 of SKILL.md) dispatches ready tasks to agents and moves to the next batch when all complete. When a sub-agent fails or produces incorrect output, the task is marked COMPLETE by the SubagentStop hook regardless of quality. There is no verify-then-retry cycle within the e | 2026-05-12 |
| [2026-03-28-openbao-improvements.md](./insights/2026-03-28-openbao-improvements.md) | No proposals reached medium or low confidence. All patterns were skipped outright. | 2026-05-12 |
| [2026-03-28-openbao-utilization.md](./insights/2026-03-28-openbao-utilization.md) | OpenBao exposes callable integration surfaces at three layers: | 2026-05-12 |
| [2026-03-28-OpenSpace-improvements.md](./insights/2026-03-28-OpenSpace-improvements.md) | `task_status_hook.py` tracks task-level status transitions and LastActivity timestamps. No skill-level usage metrics exist anywhere in the codebase. When a skill is loaded via SKILL.md, there is no record of whether the skill's guidance was followed, whether the task succeeded while using that skill, or how often a ski | 2026-05-12 |
| [2026-03-28-OpenSpace-utilization.md](./insights/2026-03-28-OpenSpace-utilization.md) | OpenSpace documents multiple callable integration mechanisms: | 2026-05-12 |
| [2026-03-28-pocketbase-improvements.md](./insights/2026-03-28-pocketbase-improvements.md) | Task status updates are written to YAML plan files and SQLite dispatch state by `task_status_hook.py` on PostToolUse and SubagentStop events. Status consumers (orchestrators, `/dh:implement-feature`) poll via `sam_status` or `dispatch_wave_status` MCP tools. There is no push-based notification when a task status change | 2026-05-12 |
| [2026-03-28-pocketbase-utilization.md](./insights/2026-03-28-pocketbase-utilization.md) | PocketBase documents concrete integration surfaces (REST API, JavaScript/Dart SDKs, CLI binary, realtime subscriptions via SSE, hook-based extensibility), but the Claude Skills codebase has **no systems that would benefit from PocketBase integration**. | 2026-05-12 |
| [2026-03-28-ruflo-improvements.md](./insights/2026-03-28-ruflo-improvements.md) | The implement-feature progress loop (SKILL.md lines 38-100) dispatches ready tasks to agents, checks for `<concerns>` blocks in agent output, and appends concerns to the backlog item. Between batches, it calls `sam_status` to check task counts but does not re-validate that completed task outputs align with the original | 2026-05-12 |
| [2026-03-28-solace-agent-mesh-improvements.md](./insights/2026-03-28-solace-agent-mesh-improvements.md) | `swarm-operations/SKILL.md` defines a `permission_request` message type (line 254) that allows a single agent to request sandbox/tool permissions from the user. When an orchestrator spawns a teammate via `Agent()`, no permission scope is propagated in the spawn call or in subsequent `SendMessage` calls. Each spawned ag | 2026-05-12 **[Skills removed in PR #3422 (`4e1e73bd6`, 2026-09-06); see the linked entry's removed-skill note.]** |
| [2026-03-28-takt-improvements.md](./insights/2026-03-28-takt-improvements.md) | Skills are self-contained SKILL.md files with optional references/ subdirectories. Each SKILL.md contains all four concerns (role via description, policies via rules sections, domain knowledge via inline or references, procedure via workflow steps) in a single file. There is no mechanism to share a policy facet (e.g.,  | 2026-05-12 |
| [2026-03-28-worktrunk-improvements.md](./insights/2026-03-28-worktrunk-improvements.md) | The implementation-manager SKILL.md exposes `sam_status`, `sam_ready`, and `sam_list` commands for task/plan status. None of these include CI status for the branch associated with a task or plan. The work-milestone SKILL.md creates worktrees and spawns sessions but does not query or pass CI status to spawned agents. A  | 2026-05-12 |
| [2026-03-28-worktrunk-utilization.md](./insights/2026-03-28-worktrunk-utilization.md) | The `/work-milestone` skill (lines 44-48 of SKILL.md) implements wave-based parallel agent execution across isolated worktrees. It currently uses raw `git worktree add` commands within the kage-bunshin spawn loop. Worktrunk's core design is built for exactly this use case: it manages worktrees by branch name rather tha | 2026-05-12 |
| [2026-03-29-compression-monitor-improvements.md](./insights/2026-03-29-compression-monitor-improvements.md) | `task_status_hook.py` fires on every PostToolUse event (line 6-7: "PostToolUse (Write\|Edit\|Bash): Update LastActivity timestamp using context file"). The handler reads the active task context and updates a `LastActivity` timestamp in the SAM task plan. No other behavioral data is recorded -- tool name, response lengt | 2026-05-12 |
| [2026-03-29-gitagent-improvements.md](./insights/2026-03-29-gitagent-improvements.md) | The skill-creator SKILL.md defines three bundled resource directories: `scripts/`, `references/`, and `assets/` (lines 164-167 of skill-creator/SKILL.md). There is no `examples/` directory in the skill anatomy. GitAgent's skill structure includes an explicit `examples/` directory for calibration interactions (example i | 2026-05-12 |
| [2026-03-29-hyperagents-improvements.md](./insights/2026-03-29-hyperagents-improvements.md) | The complete-implementation skill dispatches either 3 tasks (proportional quality gates for issues without a plan) or 6 tasks (full SAM quality gates). Within the 6-task SAM path, all 6 phases must reach terminal status sequentially (T1 code review, T2 feature verification, T3 integration check, T4 doc drift audit, T5  | 2026-05-12 |
| [2026-03-29-omma-build-improvements.md](./insights/2026-03-29-omma-build-improvements.md) | The SAM task plan uses a static dependency DAG defined at plan-creation time. Tasks become ready only when all predecessor tasks reach COMPLETE status. An agent working on Task B cannot consume partial output from Task A -- it must wait for Task A to fully complete. File: plugins/development-harness/skills/implement-fe | 2026-05-12 |
| [2026-03-29-pretext-utilization.md](./insights/2026-03-29-pretext-utilization.md) | Pretext documents a callable integration surface: | 2026-05-12 |
| [2026-03-29-rope-improvements.md](./insights/2026-03-29-rope-improvements.md) | The code-reviewer agent (plugins/python3-development/agents/code-reviewer.md) performs code review entirely via LLM reading and judgment, supplemented by linting tools (ruff, mypy, pyright) loaded via the holistic-linting skill. There is no programmatic AST-based analysis for scope-aware symbol detection, occurrence co | 2026-05-12 |
| [2026-03-29-rope-utilization.md](./insights/2026-03-29-rope-utilization.md) | The research entry documents **rope** (v1.14.0) as a pure-Python refactoring library with concrete, callable integration surfaces: | 2026-05-12 |
| [2026-04-03-boneyard-utilization.md](./insights/2026-04-03-boneyard-utilization.md) | The `dot-dash` frontend connects to Claude Code session data via WebSocket. When the page first loads or when a new session is selected, the user sees empty state placeholders (`"No sessions registered"` in SessionList, `"Select a session to view transcript"` in Transcript). During the async data stream, there is a per | 2026-05-12 |
| [2026-04-03-compound-engineering-plugin-improvements.md](./insights/2026-04-03-compound-engineering-plugin-improvements.md) | The `swarm-patterns` skill (Pattern 1 -- Parallel Specialists) dispatches multiple review agents in parallel, but agents return unstructured findings as free-text messages via `SendMessage`. There is no mechanism to: | 2026-05-12 **[Skills removed in PR #3422 (`4e1e73bd6`, 2026-09-06); see the linked entry's removed-skill note.]** |
| [2026-04-03-mission-control-improvements.md](./insights/2026-04-03-mission-control-improvements.md) | `task_status_hook.py` writes `**LastActivity**: {ISO timestamp}` to task sections on every Write, Edit, or Bash call (PostToolUse hook, lines 186-191 of SKILL.md). However, no process reads this field to detect or act on stalled agents at the SAM task level. The `sam_ready` and `sam_status` MCP tools return task status | 2026-05-12 |
| [2026-04-03-mission-control-utilization.md](./insights/2026-04-03-mission-control-utilization.md) | The `swarm-orchestrating` and `swarm-operations` skills document multi-agent execution patterns (parallel specialists, pipeline, convoy mode from Mission Control v2.3+) but do not address cost visibility. When orchestrating teams of 3-5 agents running simultaneously (Convoy Mode pattern, per research lines 72-80), cost | 2026-05-12 **[`swarm-orchestrating` never existed under any path in this repository — the real skill was `orchestrating-swarms`, itself removed in PR #3422 (`4e1e73bd6`) along with `swarm-operations`; see the linked entry.]** |
| [2026-04-03-stop-slop-improvements.md](./insights/2026-04-03-stop-slop-improvements.md) | `validate_research.py` checks structure (section_completeness, header_fields, empty_sections), freshness (statistics_currency, freshness_tracking), and formatting (url_format, access_dates, formatting_suggestions). No check examines prose quality, AI writing patterns, or directness of language. File: `.claude/skills/re | 2026-05-12 |
| [2026-04-05-empirica-improvements.md](./insights/2026-04-05-empirica-improvements.md) | `task_status_hook.py` records task status transitions (not-started, in-progress, complete) and timestamps (Started, LastActivity, Completed). `complete-implementation/SKILL.md` runs quality gates (code review, test verification, acceptance check) and records pass/fail outcomes. Neither system captures structured episte | 2026-05-12 |
| [2026-04-05-research-mode-improvements.md](./insights/2026-04-05-research-mode-improvements.md) | The research-curator agent at `.claude/agents/research-curator.md` lists tools in a `<research_tools>` section (lines 73-113) without ordering them by cost or reliability. The tools are grouped by type (documentation sites, code/API research, repository clone, GitHub metadata, fallback) but no cascade or priority order | 2026-05-12 |
| [2026-04-05-soulforge-improvements.md](./insights/2026-04-05-soulforge-improvements.md) | The swarm-operations SKILL.md documents Agent dispatch with `team_name`, `name`, `prompt`, and `run_in_background` parameters. The swarm-patterns SKILL.md shows Pattern 6 (Coordinated Multi-File Refactoring) where file boundaries are established by convention in the prompt text ("Claim task #1, refactor the User model" | 2026-05-12 **[Skills removed in PR #3422 (`4e1e73bd6`, 2026-09-06); see the linked entry's removed-skill note.]** |
| [2026-04-05-soulforge-utilization.md](./insights/2026-04-05-soulforge-utilization.md) | The `context-gathering` agent builds comprehensive context manifests for new tasks by reading files, understanding architecture, and tracing code paths. Currently this is a manual process requiring exhaustive file reads and pattern discovery. SoulForge's Live Soul Map (documented in soulforge.md lines 44-51) addresses  | 2026-05-12 |
| [2026-04-06-meta-harness-improvements.md](./insights/2026-04-06-meta-harness-improvements.md) | The kaizen-improvement skill reads findings from `.planning/kaizen/` (analysis output from transcript-analysis), scores them by frequency x impact, and generates improvement proposals. However, it operates on the current session's findings only. There is no structured filesystem store that accumulates: (a) all prior im | 2026-05-12 |
| [2026-04-06-Trellis-improvements.md](./insights/2026-04-06-Trellis-improvements.md) | The SessionStart hook (`plugins/development-harness/hooks/session-start-session-id.cjs`) captures the session ID from stdin JSON and injects it as `CLAUDE_CODE_SESSION_ID` into the environment. It does not read any prior session state, task context, or workspace journal. When an agent session starts (or resumes after c | 2026-05-12 |
| [2026-04-08-arxitect-improvements.md](./insights/2026-04-08-arxitect-improvements.md) | The `@dh:code-reviewer` agent (plugins/development-harness/agents/code-reviewer.md, Step 5 "Apply Universal Quality Dimensions") checks 7 dimensions: Security, Correctness, Test Coverage, API Contract Compliance, Naming and Readability, Error Handling, and Performance Indicators. These dimensions focus on correctness a | 2026-05-12 |
| [2026-04-08-codegraphcontext-improvements.md](./insights/2026-04-08-codegraphcontext-improvements.md) | 2026 04 08 codegraphcontext improvements | 2026-05-12 |
| [2026-04-08-codegraphcontext-utilization.md](./insights/2026-04-08-codegraphcontext-utilization.md) | The doc-drift-auditor agent currently performs static code analysis via grep and heuristics to catalog implemented features and compare them against documentation claims (see `.claude/agents/doc-drift-auditor.md` lines 39-94). This approach relies on pattern matching and file path assumptions, which can miss implicit i | 2026-05-12 |
| [2026-04-08-graphify-improvements.md](./insights/2026-04-08-graphify-improvements.md) | The research-curator agent (`.claude/agents/research-curator.md`, lines 119-232) uses a two-phase extractive methodology. Each extracted passage records its source (`Source: {URL or tool + section}`) and relevance (`Relevance: {section name}`). Phase 1b code extracts add `Confidence: code-read`. The final entry include | 2026-05-12 |
| [2026-04-08-graphify-utilization.md](./insights/2026-04-08-graphify-utilization.md) | The context-gathering agent currently traces codebases manually by reading implementation files, call paths, and data access patterns sequentially (per the agent file, lines 26-40). For large codebases, this manual approach is token-expensive and misses cross-domain connections. graphify extracts structural relationshi | 2026-05-12 |
| [2026-04-08-mempalace-improvements.md](./insights/2026-04-08-mempalace-improvements.md) | The `.claude/hooks/` directory contains three hooks: `run-commands-try-all.cjs` (command execution), `validate-delegation.cjs` (delegation validation), `stop-backlog-reminder.cjs` (backlog reminders). None of these hooks fires on context compression events. When a Claude Code session approaches context window limits an | 2026-05-12 |
| [2026-04-08-mempalace-utilization.md](./insights/2026-04-08-mempalace-utilization.md) | > **Review note (2026-04-08)**: All three proposals below need comparing against Claude Code's built-in `memory: project` agent frontmatter field before proceeding. Sub-agents are normally disposable — their context is discarded after task completion. When persistence is needed, agents can be given `memory: project` wh | 2026-05-12 |
| [2026-04-11-tabularis-improvements.md](./insights/2026-04-11-tabularis-improvements.md) | `references/real-world-patterns.md` contains a trivial `DatabaseServer` stub example (line 23-34) that mounts a `query_users` tool returning an empty list `[]`. No real-world database MCP server pattern demonstrates schema introspection tools (`list_tables`, `describe_table`, `run_query`) or connection management. An a | 2026-05-12 |
| [2026-04-12-duckdb-python-client-utilization.md](./insights/2026-04-12-duckdb-python-client-utilization.md) | - `duckdb.connect(path)` — persistent database connections - `duckdb.sql(query)` — global default connection - `duckdb.from_df()`, `from_arrow()`, `from_parquet()` — DataFrame interoperability - Relation API for programmatic query construction | 2026-05-12 |
| [2026-04-12-pandera-utilization.md](./insights/2026-04-12-pandera-utilization.md) | The python-pytest-architect agent (lines 3, 22, 40-42 of its agent file) explicitly lists "hypothesis property-based tests" as a core competency and mentions "Hypothesis Integration" as a key feature in its quality checklist ("mutation testing plan"). The research entry documents Pandera's hypothesis integration featur | 2026-05-12 |
| [2026-04-12-pyscript-improvements.md](./insights/2026-04-12-pyscript-improvements.md) | The "Relevance to Claude Code Development" section of the PyScript research entry lists application-level use cases and integration opportunities, not mechanism-level patterns that the local skill/agent/workflow systems could adopt. PyScript is a browser runtime platform (Python-to-WASM, DOM FFI, web workers) architect | 2026-05-12 |
| [2026-04-20-orchestra-improvements.md](./insights/2026-04-20-orchestra-improvements.md) | _Note: these counters summarize outcomes from this Orchestra improvement-pattern review. "Research-derived backlog issues" refers to GitHub issues opened from this research pass, not to formal proposal counts used in separate utilization-assessment documents._ | 2026-05-12 |
| [2026-04-20-orchestra-utilization.md](./insights/2026-04-20-orchestra-utilization.md) | Orchestra documents the following callable surfaces: | 2026-05-12 |
| [2026-04-25-abtop-improvements.md](./insights/2026-04-25-abtop-improvements.md) | `task_status_hook.py` writes a `LastActivity` timestamp on every `Write\|Edit\|Bash` PostToolUse event (lines 15, 854, 930-933 — confirmed via Read). `implementation_manager.py status` and `ready-tasks` commands report `in_progress`, `not_started`, `blocked`, `deferred`, `skipped` task counts (lines 1060-1067) but neve | 2026-05-12 |
| [2026-04-25-honker-improvements.md](./insights/2026-04-25-honker-improvements.md) | The research entry's "Relevance to Claude Code Development" section enumerates speculative future-state applications ("could serve as", "could migrate") rather than naming gaps in existing local systems. Each "Pattern Worth Adopting" presupposes architectural primitives the local systems do not have: an in-process asyn | 2026-05-12 |
| [2026-04-25-honker-utilization.md](./insights/2026-04-25-honker-utilization.md) | The dispatch orchestration system in `dispatch_state.py` manages wave execution by tracking item state (`pending`, `in-progress`, `complete`, `failed`) in a custom SQLite schema. Currently, item failures are manual (`set_item_failed()`). Honker's at-least-once queue with exponential backoff, dead-letter tables, and dec | 2026-05-12 |
| [2026-04-25-raincast-improvements.md](./insights/2026-04-25-raincast-improvements.md) | `init_skill.py` (scripts/init_skill.py) emits a single SKILL_TEMPLATE constant with TODO placeholders regardless of the skill's intended purpose. The template is generic — every new skill produced by `init_skill.py my-skill --path X` starts from the same skeleton with bracketed `[TODO: ...]` markers and no domain-aware | 2026-05-12 |
| [2026-04-25-wrkflw-improvements.md](./insights/2026-04-25-wrkflw-improvements.md) | `./.pre-commit-config.yaml` runs no GitHub Actions schema validator. The closest checks are `check-yaml` (lines 61–62) which validates raw YAML parsability only, and a generic `markdownlint-cli2` for docs. There is no hook that parses `.github/workflows/*.yml` against the Actions schema (jobs, steps, expressions, `uses | 2026-05-12 |
| [2026-04-26-TheAlgorithms-Python-improvements.md](./insights/2026-04-26-TheAlgorithms-Python-improvements.md) | `python3-standards.md` covers type safety, architecture, error handling, performance, and testing, but lacks naming guidance beyond behavioral test names. | 2026-05-12 |
| [2026-04-26-tolaria-improvements.md](./insights/2026-04-26-tolaria-improvements.md) | The research-curator skill rewrites entries (`--rerun`, `--validate --fix`, default mode) and updates `./research/README.md` via direct `Write`/`Edit` calls. There is no transactional staging directory, no atomic-rename mechanism, and no recovery helper. If a rewrite fails partway (process crash, disk-full, OOM kill, n | 2026-05-12 |
| [2026-04-26-tolaria-utilization.md](./insights/2026-04-26-tolaria-utilization.md) | The research-context-agent (deleted 2026-09-13, PR #3529) discovered integration opportunities by searching the repo codebase (skills, agents, plugins, commands) and validated claims against primary sources. It searched for existing skill/agent/hook/command coverage, then proposed new capabilities. | 2026-05-12 |
| [2026-04-29-mattpocock-skills-improvements.md](./insights/2026-04-29-mattpocock-skills-improvements.md) | plugin-creator:skill-creator teaches skill structure following philosophy → workflow → checklists pattern. Reading skill-creator/SKILL.md reveals no Anti-Patterns section required or documented in the template. Agents instructed by skill-creator may produce skills lacking explicit warnings about failure modes. | 2026-05-12 |
| [2026-04-29-openspec-mcp-improvements.md](./insights/2026-04-29-openspec-mcp-improvements.md) | The backlog lifecycle implements state transitions via GitHub issue labels (`status:groomed`, `status:in-progress`, `status:done`) but does not enforce a strict state machine. The `backlog_close` tool accepts any terminal reason (`duplicate`, `out_of_scope`, `superseded`, `wontfix`, `blocked`) without validation of pri | 2026-05-12 |
| [2026-04-29-openspec-mcp-utilization.md](./insights/2026-04-29-openspec-mcp-utilization.md) | The `/dh:implement-feature` skill (research entry Section "Integration Opportunities") runs an execution loop where agents implement tasks from a feature plan. Currently, task progress is tracked by reading and parsing local plan files in `.dh/projects/{slug}/`. OpenSpec MCP exposes `openspec_get_progress_summary` and  | 2026-05-12 |
| [2026-05-02-browser-harness-js-improvements.md](./insights/2026-05-02-browser-harness-js-improvements.md) | The research entry has no explicit "Patterns Worth Adopting" or "Integration Opportunities" sub-section. It does have a populated "Relevance to Claude Code Development" section (lines 316–334) and a "Key Features" section (lines 42–154) that names concrete patterns. These were used as the source of patterns to assess. | 2026-05-12 |
| [2026-05-02-claude-brain-improvements.md](./insights/2026-05-02-claude-brain-improvements.md) | Session knowledge in this repo lives in two non-portable locations: | 2026-05-12 |
| [2026-05-02-esp-claw-improvements.md](./insights/2026-05-02-esp-claw-improvements.md) | `./.claude/skills/research-curator/references/batch-mode.md` line 67 specifies: "Before spawning, check if `./research/` already contains an entry for the URL's resource. If found, skip with info message suggesting `--rerun` instead." Verified by Grep: only `batch-mode.md` line 31 mentions "deduplicated URLs" — dedupli | 2026-05-12 |
| [2026-05-02-screenpipe-improvements.md](./insights/2026-05-02-screenpipe-improvements.md) | deployment.md describes transport selection (`stdio`, `http`, `sse`, `streamable-http`) at lines 399, 536, 546, and transforms.md:261-291 documents tag-based enable/disable mechanisms. Neither file explicitly demonstrates how to gate a tool by transport — e.g., "expose `read` tools over HTTP, but only expose `write` to | 2026-05-12 |
| [2026-05-02-tolaria-improvements.md](./insights/2026-05-02-tolaria-improvements.md) | > Note: A second Tolaria research entry exists at `./research/developer-tools/tolaria.md` (created 2026-04-26) with a more detailed "Patterns Worth Adopting" section. The 4 actionable improvements from that entry were captured in `./research/insights/2026-04-26-tolaria-improvements.md` and produced backlog items #1949, | 2026-05-12 |
| [2026-05-03-cua-improvements.md](./insights/2026-05-03-cua-improvements.md) | CUA is agent-agnostic and explicitly supports "any LLM provider" including Claude. No documented guidance exists for running Claude agents within CUA's environment abstraction and benchmarking framework. | 2026-05-12 |
| [2026-05-03-homebutler-improvements.md](./insights/2026-05-03-homebutler-improvements.md) | - Adopt the CLI-first → MCP-extension pattern in Claude Code agent workflows - Document HomeButler's binary distribution approach as a reference architecture for future MCP servers - Create a skill that wraps HomeButler's MCP interface for infrastructure-aware agent tasks - Use HomeButler as a reference for designing o | 2026-05-12 |
| [2026-05-03-huashu-design-improvements.md](./insights/2026-05-03-huashu-design-improvements.md) | `./.claude/CLAUDE.md` Critical Constraints fires verification only on hedging language emitted by the agent — `"likely"`, `"probably"`, `"I think"` — not on named entities present in the user prompt. The reactive `./.claude/skills/fact-check/SKILL.md` runs after content already exists and requires an `UNVERIFIED` tag o | 2026-05-12 |
| [2026-05-03-huashu-design-utilization.md](./insights/2026-05-03-huashu-design-utilization.md) | The `/prepare-walkthrough-presentation` skill produces structured deck outlines as markdown files in `presentation/decks/` (Phase 4, deliverable in SKILL.md line 141). These outlines contain slide-by-slide narrative, speaker notes, and visual suggestions—the raw material for a presentation. Currently, these artifacts r | 2026-05-12 |
| [2026-05-03-no-mistakes-improvements.md](./insights/2026-05-03-no-mistakes-improvements.md) | `/complete-implementation` runs all 6 quality-gate phases (T1 Code Review through T6 Context Refinement) directly against the developer's current working tree. The SKILL.md only mentions "worktree-isolated agents" once (line 354), referring to plan-artifact discovery via the artifact manifest — not to running the gates | 2026-05-12 |
| [2026-05-04-waza-improvements.md](./insights/2026-05-04-waza-improvements.md) | `.claude-plugin/marketplace.json` lists 30 plugins as `{ "name": "...", "source": "./plugins/..." }` entries. Plugin auto-sync is handled by `plugins/plugin-creator/scripts/auto_sync_manifests.py`, which updates plugin component arrays and version fields on commit. There is no validator that wa | 2026-05-12 |
| [2026-05-04-waza-utilization.md](./insights/2026-05-04-waza-utilization.md) | The `analyze-test-failures` skill in development-harness guides agents through debugging test failures, but it is context-limited to test execution output within a single codebase. Waza's `/hunt` skill ("bugs, crashes, regressions, test failures, unexpected behavior") is a generalized debugging entrypoint that enforces | 2026-05-12 |
| [2026-05-05-cursor-cookbook-improvements.md](./insights/2026-05-05-cursor-cookbook-improvements.md) | The `Task` Pydantic model at `plugins/development-harness/sam_schema/core/models.py:114` defines fields for status, dependencies, timestamps, content (description/objective/requirements), and `handoff: str = ""` (line 210), but has no field that captures the structured **output or result summary** of a completed task i | 2026-05-12 |
| [2026-05-07-claude-code-harness-improvements.md](./insights/2026-05-07-claude-code-harness-improvements.md) | The PreToolUse[Bash] hook chain in `plugins/development-harness/hooks/hooks.json` registers exactly one script: `block-context-direct-writes.cjs`. Reading lines 35-86 of that script confirms it only matches writes to `active-task-*.json` files (4 narrow regex patterns). It does not look for `sudo`, `git push --force`,  | 2026-05-12 |
| [2026-05-08-sigmap-improvements.md](./insights/2026-05-08-sigmap-improvements.md) | The bulk of SigMap's actionable value to this repo lies in **utilization** (using SigMap as an external context-generation tool), not in patterns that extend existing local systems. The "Integration Opportunities" section of the research entry — "Agent-generated SAM task plans could use `sigmap plan`", "Skill context p | 2026-05-12 |
| [2026-05-08-sigmap-utilization.md](./insights/2026-05-08-sigmap-utilization.md) | The context-gathering agent currently reads files manually and traces dependencies to build a comprehensive context manifest for task execution (per .claude/agents/context-gathering.md). Its "Step 2: Research Everything" phase involves hunting down features, services, components, and error handling patterns — a process | 2026-05-12 |
| [2026-05-09-agent-skills-eval-improvements.md](./insights/2026-05-09-agent-skills-eval-improvements.md) | `run_eval.py` is hardcoded to invoke the `claude` CLI as a subprocess (see lines 75–88, `_build_claude_cmd`). The script has no provider interface, no `baseUrl`/`apiKey` parameters, and no abstraction over completion. As a result the eval workflow cannot be exercised against alternative model backends (mock provider fo | 2026-05-12 |
| [2026-05-10-awesome-codex-skills-issue-triage-improvements.md](./insights/2026-05-10-awesome-codex-skills-issue-triage-improvements.md) | `find_fuzzy_duplicates(title, items, threshold)` exists in `parsing.py:481-516` and uses `difflib.SequenceMatcher` on normalized titles. It is called only by `_check_for_duplicates` in `operations.py:1621-1637`, which runs at item-creation time inside `backlog_add`. There is **no** MCP tool that takes the set of open i | 2026-05-12 |
| [2026-05-10-awesome-codex-skills-issue-triage-utilization.md](./insights/2026-05-10-awesome-codex-skills-issue-triage-utilization.md) | The `complete-milestone` skill currently implements Steps 1–3 of issue lifecycle management: auditing open vs. closed issue counts, displaying state, and offering to reassign issues to new/existing milestones. Today this is done via GitHub REST API calls in `backlog_list_issues()` and `backlog_create_milestone()` (line | 2026-05-12 |
| [2026-05-10-brooks-lint-improvements.md](./insights/2026-05-10-brooks-lint-improvements.md) | `plugins/development-harness/agents/code-reviewer.md` lines 200–211 specify the Output Format for findings as: | 2026-05-12 |
| [2026-05-10-codebase-recon-skill-improvements.md](./insights/2026-05-10-codebase-recon-skill-improvements.md) | `linear-walkthrough/SKILL.md` uses a fixed 50k-token-per-agent read budget regardless of repository size (lines 36, 53, 68, line 40 of references/agent-instructions.md). The Discovery phase (Phase 1) writes a coverage plan, but coverage plan agent assignments are sized only by total file bytes per file (`~4 characters  | 2026-05-12 |
| [2026-05-10-composio-codebase-migrate-improvements.md](./insights/2026-05-10-composio-codebase-migrate-improvements.md) | `plugins/development-harness/skills/work-milestone/SKILL.md` lines 22–96 implements a single-integration-branch landing model. Per-wave merges (lines 60–73, MergeLoop → MergeResult → WaveComplete) all happen LOCALLY on `milestone/{N}-{slug}`. Only at Step 9 (line 91) does the integration branch reach `git push origin m | 2026-05-12 |
| [2026-05-10-composio-codebase-migrate-utilization.md](./insights/2026-05-10-composio-codebase-migrate-utilization.md) | **Composio CLI** — Command-line orchestration tool with executor API | 2026-05-12 |
| [2026-05-10-gh-skill-improvements.md](./insights/2026-05-10-gh-skill-improvements.md) | `setup_gh.py` (lines 1-770) performs platform detection, binary download, SHA256 verification, and PATH installation, but never inspects git remote configuration. There is zero occurrence of `remote`, `proxy`, `127.0.0.1`, or `git config` in the script (verified via grep on 2026-05-10). | 2026-05-12 |
| [2026-05-10-gh-skill-utilization.md](./insights/2026-05-10-gh-skill-utilization.md) | The `create-milestone` skill currently delegates milestone creation to the `github_project_setup.py` script at line 87, invoking a custom Python wrapper around GitHub's REST API. Reading the research entry (lines 174–179, "No native milestone subcommand"), the skill has no dedicated `gh milestone` subcommand, so it use | 2026-05-12 |
| [2026-05-10-octogent-improvements.md](./insights/2026-05-10-octogent-improvements.md) | The swarm patterns in `.claude/skills/swarm-patterns/SKILL.md` Pattern 3 (Self-Organizing) require the orchestrator to write per-task `TaskCreate({ subject, description, activeForm })` calls before spawning workers. There is no mechanism to read a markdown file containing checkbox items (`- [ ] description`) and auto-g | 2026-05-12 **[Skills removed in PR #3422 (`4e1e73bd6`, 2026-09-06); see the linked entry's removed-skill note.]** |
| [2026-05-25-pilot-shell-improvements.md](./insights/2026-05-25-pilot-shell-improvements.md) | **Research entry**: ./research/coding-agents/pilot-shell.md **Generated**: 2026-05-25 **Patterns assessed**: 9 **Backlog items created**: 4 (issues recorded inline below) **Deferred (low confidence)**: 3 **Skipped (al... | 2026-05-25 |
| [2026-05-25-claude-codepro-improvements.md](./insights/2026-05-25-claude-codepro-improvements.md) | **Research entry**: ./research/coding-agents/claude-codepro.md **Generated**: 2026-05-25 MCP lazy-loading mechanism gap deferred pending upstream source read (maxritter/claude-codepro); no IMMEDIATE_ATTENTION items at this time. | 2026-05-25 |

### Installer Tools

**Location**: [./installer-tools/](./installer-tools/)
...
| Document | Description | Last Updated |
|---|---|---|
| [2026-05-03-cua-utilization.md](./utilization/2026-05-03-cua-utilization.md) | CUA presents **4 direct integration surfaces** for this codebase. The platform is feature-complete, actively maintained (476 releases, last update May 2, 2026), and provides infrastructure that complements the agent-centric architecture already present in claude_skills. | 2026-05-12 |
| [2026-05-03-homebutler-utilization.md](./utilization/2026-05-03-homebutler-utilization.md) | HomeButler presents **direct integration opportunities** as an MCP server dependency and as a reference pattern for skill design. | 2026-05-12 |
