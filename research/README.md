...
| [2026-03-17-ctxforge-improvements.md](./insights/2026-03-17-ctxforge-improvements.md) | The `rules/` directory contains 13 rule files focused on structural concerns: silent failure prevention, large file write strategy, interactive terminal workarounds, language conventions, script invocation, linting exceptions, CI workflows, YAML/TOML libraries, plugin development, skill content optimization, fr | 2026-05-12 |
