...
| [esp-claw](./esp-claw.md) | agent-frameworks | Event-driven multi-agent orchestration approach contrasts with ESP-CLAW's single-device focus but shares event-scheduler and autonomous execution patterns (bidirectional) |
