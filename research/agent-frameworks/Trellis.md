...
| [omnigent](./omnigent.md) | agent-frameworks | Multi-platform AI coding framework abstracting Claude Code, Cursor, OpenCode—shares Omnigent's core goal of unified harness abstraction across tools (bidirectional) |
