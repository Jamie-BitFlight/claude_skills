...
| Convention-Based Agent Guidance — single AGENTS.md drives Claude Code, Codex, Gemini uniformly | Already implemented: `./AGENTS.md` (292 lines) exists at repo root and serves as the multi-tool guide. Tolaria's promise is that a single file unifies guidance across multiple AI CLIs — this repo already follows that convention. |
