...
| Dependency isolation via uv | Already covered — the local repo uses `uv` as the primary package manager (documented in CLAUDE.md Session Start). All Python scripts run via `uv run`. |
