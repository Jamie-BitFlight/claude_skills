...
| [uv](./plugins/uv) | `uv` | Expert guidance for Astral's uv — the fast Python package manager that replaces pip, poetry, pyenv, and virtualenv with modern lockfiles. **Superseded by `astral`; scheduled for removal.** |
