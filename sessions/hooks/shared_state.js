...
class EnabledFeatures {
  constructor(data = {}) {
    ...
    this.context_warnings =
      data.context_warnings instanceof ContextWarnings
...
class SessionsTodos {
  ...
  allComplete() {
    return this.active.length > 0 && this.active.every((t) => t.status === TodoStatus.COMPLETED);
  }
