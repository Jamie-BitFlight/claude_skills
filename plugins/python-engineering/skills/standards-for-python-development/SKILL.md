...
- **Type Checking (mypy/ty/pyright/basedpyright coexistence)**: Load `Skill(skill="python-engineering:python3-core")` for the full mypy-vs-ty detection heuristic, the IDE-coexistence stub-config recipe, and the basedpyright/pyright inference rule.
