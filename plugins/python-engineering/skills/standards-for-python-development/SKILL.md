...
- **Type Checking (mypy/ty/pyright/basedpyright coexistence)**: See the `python-engineering:python3-core` skill for the full mypy-vs-ty detection heuristic, the IDE-coexistence stub-config recipe, and the basedpyright/pyright inference rule.
