...
**Project tasks where test coverage is missing for touched code**: record the gap to `.claude/plans/test-coverage-gaps.md` (create the directory if it does not exist). Append an entry using this format:
