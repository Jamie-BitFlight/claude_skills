...
Search code by meaning using `mcp__cocoindex_code__search`. Return results with file paths, line numbers, and code snippets. If the tool is unavailable, report BLOCKED — do not fall back to pattern-based search.
