...
### Using /python3-development:shebangpython Command

The `/python3-development:shebangpython` command validates PEP 723 compliance:
...
See: `../../shebangpython/SKILL.md` or activate with `/python3-development:shebangpython`
...
- **Shebang Validation**: `../../shebangpython/SKILL.md` or `/python3-development:shebangpython`
