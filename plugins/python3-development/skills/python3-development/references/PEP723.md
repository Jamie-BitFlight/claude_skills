...
- Never add `--active`: it runs the script against the caller's activated virtual environment and
  installs the script's dependencies there, instead of in a throwaway environment.
