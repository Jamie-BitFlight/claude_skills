...
def validate_server(path: str) -> dict[str, list[str]]:
    ...
    for lineno, line in enumerate(source.splitlines(), start=1):
        ...
        if re.search(r"@\w+\.tool\s*\(\s*\)", stripped):
            errors.append(
