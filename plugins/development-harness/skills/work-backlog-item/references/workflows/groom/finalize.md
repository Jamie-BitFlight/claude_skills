...
```bash
uv run "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog groom --selector "{item_ref}" --section "RT-ICA" --content "{final report}"
```
...
```bash
uv run "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog groom --selector "{item_ref}" --section "RT-ICA" --content "{rt_ica_final_content}"
```
...
```bash
uv run "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog groom --selector "{item_ref}" --section "Fact-Check" --content "{fact-check}"
uv run "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog groom --selector "{item_ref}" --section "RT-ICA" --content "{rt-ica}"
