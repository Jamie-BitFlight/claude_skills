...
**Proactive fix routing**: The Proactive Fix Gate in `.claude/CLAUDE.md` (Autonomous Action
Boundary section) routes trivial discovered issues to this `--quick` path autonomously.
