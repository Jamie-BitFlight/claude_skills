...
7. Write findings to the backlog item via `uv run plugins/development-harness/sam_schema/cli.py backlog groom --selector "{title}" --section "Plan Drift" --content "..."`
...
1. Call `uv run plugins/development-harness/sam_schema/cli.py backlog view --selector "{title}"` to retrieve the full item
...
7. Write findings to the backlog item via `uv run plugins/development-harness/sam_schema/cli.py backlog groom --selector "{title}" --section "Grooming Drift" --content "..."`
