...
1. `../../docs/workflow-layers/COVERAGE.md` — identifies which layers are affected by your change type, the Tier 1 / Tier 2 update process, and what not to do

2. `../../docs/workflow-trace-methodology.md` — full extraction protocol including the ensemble pipeline, schema discipline, and collection phases
