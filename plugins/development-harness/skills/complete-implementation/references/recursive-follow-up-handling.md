...
```bash
uv run --script "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog list --title "{derived_slug}"
```
...
```bash
uv run --script "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog list --topic "{derived_slug}"
```
...
```bash
uv run --script "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog update --selector "{matched_item_title}" --plan "{plan_id}"
```
...
```bash
uv run --script "${CLAUDE_PLUGIN_ROOT}/sam_schema/cli.py" backlog update --selector "{derived_title}" --plan "{plan_id}"
```
