...
# ---------------------------------------------------------------------------
# Synthetic fixture: issue-recursive-nav.json
# ---------------------------------------------------------------------------
# NOT generated by this script — hand-crafted for T06 (TDD red phase).
#
...
#   2) The `### ` sub-heading or code-fence content in Entry 0 is changed.
#   3) The SectionEntryDict / ViewItemResult model fields change incompatibly.
#
# Do NOT regenerate this file via the `regenerate()` function above —
# it has no associated GitHub issue and is not fetched from a live backend.
