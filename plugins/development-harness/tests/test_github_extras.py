...
class TestUpdateItem:
    ...
    @_GITHUB_MARKER
    def test_update_title_is_reflected_on_fetch(self, github_backend: GitHubBackend) -> None:
    ...
    @_GITHUB_MARKER
    def test_update_body_is_reflected_on_fetch(self, github_backend: GitHubBackend) -> None:
    ...
    @_GITHUB_MARKER
    def test_update_state_to_closed(self, github_backend: GitHubBackend) -> None:
...
class TestListItems:
    ...
    @_GITHUB_MARKER
    def test_empty_backend_returns_empty_list(self, github_backend: GitHubBackend) -> None:
    ...
    @_GITHUB_MARKER
    def test_list_closed_returns_only_closed_issues(self, github_backend: GitHubBackend) -> None:
...
class TestComments:
    ...
    @_GITHUB_MARKER
    def test_add_comment_and_fetch_returns_comment(self, github_backend: GitHubBackend) -> None:
...
class TestMilestones:
    ...
    @_GITHUB_MARKER
    def test_fetch_milestones_empty_initially(self, github_backend: GitHubBackend) -> None:
