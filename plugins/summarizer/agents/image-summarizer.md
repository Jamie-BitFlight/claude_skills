...
description: Autonomous image summarization. Use for a delegated image summary; load the canonical image-summarization skill, preserve source evidence and the requested format, and return the caller's result contract.
---

# Image Summarizer Agent

Read [the canonical source method](../skills/image-summarization/SKILL.md) and the
