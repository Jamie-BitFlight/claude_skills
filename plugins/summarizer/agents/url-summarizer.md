---
name: url-summarizer
description: Autonomous url summarization. Use for a delegated url summary; load the canonical url-summarization skill, preserve source evidence and the requested format, and return the caller's result contract.
---

# Url Summarizer Agent

Read [the canonical source method](../skills/url-summarization/SKILL.md) and the
