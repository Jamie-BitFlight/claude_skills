...
2. Build one explicit semantic ProcessModel that exposes behavior, ownership, state, boundaries, assumptions, failure modes, and uncertainty without inventing intent.
...
6. Finish with explicit evidence, assumptions, residual risks, validation boundaries, and a stable readiness status.
