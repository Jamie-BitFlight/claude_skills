...
description: Review one target against one supplied rule slice and write reducer-ready findings. Use as a parallel worker in ensemble or checklist reviews.
model: haiku
