...
function buildAgentList() {
  ...
  const pluginAgents = [
    ...
    {
      key: 'dh:codebase-analyzer',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'codebase-analyzer.md',
    },
    {
      key: 'dh:dh-context-gathering',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'dh-context-gathering.md',
    },
    {
      key: 'dh:context-refinement',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'context-refinement.md',
    },
    {
      key: 'dh:doc-drift-auditor',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'doc-drift-auditor.md',
    },
    {
      key: 'dh:ecosystem-researcher',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'ecosystem-researcher.md',
    },
    {
      key: 'dh:feature-researcher',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'feature-researcher.md',
    },
    {
      key: 'dh:feature-verifier',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'feature-verifier.md',
    },
    {
      key: 'dh:integration-checker',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
      agentFile: 'integration-checker.md',
    },
    {
      key: 'dh:plan-validator',
      pluginDir: join(PLUGIN_CACHE_DIR, 'jamie-bitflight-skills/dh'),
