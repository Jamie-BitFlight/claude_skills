...
def test_fetch_flattens_pages_filters_resolved_and_handles_null_author(mocker: MockerFixture) -> None:
            ...
            nodes=[
                {
                    ...
                    "comments": {
                        ...
                        "nodes": [{"databaseId": 1, "body": "hi", "line": 5, "originalLine": 5}],
                    },
                },
                {
                    "id": "T2",
                    ...
                    "comments": {
                        "totalCount": 1,
                        "pageInfo": {"hasNextPage": False},
                        "nodes": [{"databaseId": 2, "body": "already resolved", "line": 1, "originalLine": 1}],
                    },
                },
            ],
        ),
            ...
            nodes=[
                {
                    ...
                    "comments": {
                        ...
                        "nodes": [{"databaseId": 3, "body": "flagged", "line": None, "originalLine": 10}],
                    },
                }
            ],
        ),
    ...
    reviews_pages = [
        _reviews_page(
            total_count=2,
            nodes=[
                {"author": {"login": "codex"}, "state": "COMMENTED", "body": "Some feedback"},
