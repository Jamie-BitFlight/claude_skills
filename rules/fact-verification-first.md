...
| Named software product or AI model | "Gemini 3 Pro", "Claude Sonnet 5", "GPT-5" | WebSearch BEFORE planning |
...
Both `WebSearch` and `mcp__Ref-local__ref_search_documentation` are acceptable verification tools. Use whichever returns current, authoritative information for the named entity.
